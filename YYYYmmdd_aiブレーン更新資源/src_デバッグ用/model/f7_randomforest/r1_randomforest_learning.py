...
def call(params, logger, out_dir):
    ...
    重要度出力＞csv
    """
    l = lambda x:x[0](x[1]); l(logger.format_log_message("AIR001001", ["r1_randomforest_learning"]))
    ...
    l = lambda x:x[0](x[1]); l(logger.format_log_message("AIR001002", ["r1_randomforest_learning"]))