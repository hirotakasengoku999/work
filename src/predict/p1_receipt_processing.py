...
from src.predict.f7_randomforest.s_re_rese import call as rese  # 15


def p1_main(config, logger, input_path, predict_flag):
    l = lambda x:x[0](x[1]); l(logger.format_log_message("AIR001001", ["p1_receipt_processing"]))
    ...
    for key, params in config.items():
        try:
            ...
            raise
    l = lambda x:x[0](x[1]); l(logger.format_log_message("AIR001002", ["p1_receipt_processing"]))
